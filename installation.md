...
## Setup Steps
1. Mount Windows ISO on on the workstation vmware and install offline using `OOBE\BYPASSNRO`without requiring a microsoft account and connceting to the internet.
...
5. Download and install Flare VM via the official script:
```powershell
